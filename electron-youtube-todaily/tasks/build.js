...
gulp.task('watch', function () {
    gulp.watch(['app/**/*.js',"!node_modules/**"], ['bundle-watch']);
    gulp.watch(['app/**/*.html','app/**/*.json',"!node_modules/**"],function(cb){
        return gulp.src(['app/**/*.html','app/**/*.json',"!node_modules/**"])
                    .pipe(gulp.dest("./build"));

    });
    //gulp.watch(paths.copyFromAppDir, { cwd: 'app' }, ['copy-watch']);
    gulp.watch(['app/**/*.less',"!node_mdoules/**"], ['less-watch']);
});
